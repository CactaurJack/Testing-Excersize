...
namespace LobsterPotTests
{
    public class GameLogicTests
    {
        ...
        [Fact]
        public void WrongGuessShouldStartAtZero()
        {
            GameLogic game = new GameLogic("secret");
        ...
        [Fact]
        public void WrongGuessesShouldIncrimentWrongGuesses()
        {
            GameLogic game = new GameLogic("secret");
            game.Guess('w');
        ...
        [Fact]
        public void SevenWrongGuessesShouldEndTheGameWithALoss()
        {
            GameLogic game = new GameLogic("secret");
            game.Guess('w');
            game.Guess('f');
        ...
        [Fact]
        public void CorrectGuessShouldReturnCorrectEnumValue()
        {
            GameLogic game = new GameLogic("secret");
        ...
        [Fact]
        public void GuessesShouldBeCaseInsensitive()
        {
            GameLogic game = new GameLogic("Secret");
            Assert.Equal(GuessResult.Correct, game.Guess('s'));
